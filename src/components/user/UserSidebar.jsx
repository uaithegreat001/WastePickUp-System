...
export default function UserSidebar({ isOpen, toggleSidebar, counts = {} }) {
    ...
    const menuItems = [
        ...
        { name: 'Message', icon: 'hugeicons:align-box-middle-left', path: '/user/support', countKey: 'messages' },
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-0 w-full p-4 border-t border-gray-200">
                ...
                >
                    <Icon icon={loggingOut ? "hugeicons:loading-03" : "hugeicons:logout-02"} className={`w-5 h-5 ${loggingOut ? 'animate-spin' : ''}`} />
